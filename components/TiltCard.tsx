...
export default function TiltCard({
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-2xl border border-black/10 dark:border-white/10 transition-colors duration-700 bg-black/40 backdrop-blur-sm group overflow-hidden ${className}`}
    >
